		...
		return gbox.addObject({
			...
			levelIntroAnimation:function(reset) {
		  		if (reset) {
		  			...
		  			gbox.blitFade(gbox.getBufferContext(),{alpha:1});
		  			return toys.text.blink(this,"default-blinker",gbox.getBufferContext(),{font:"small",text:"Try again!",valign:gbox.ALIGN_MIDDLE,halign:gbox.ALIGN_CENTER,dx:0,dy:0,dw:gbox.getScreenW(),dh:gbox.getScreenH(),blinkspeed:5,times:6});
		  		}
		 	 },
		  	 ...
		  	 newlifeIntroAnimation:function(reset) {
		 		 if (reset) {
		  			...
		  			gbox.blitFade(gbox.getBufferContext(),{alpha:1});
		  			return toys.text.fixed(this,"default-blinker",gbox.getBufferContext(),{font:"small",text:"Try again!",valign:gbox.ALIGN_MIDDLE,halign:gbox.ALIGN_CENTER,dx:0,dy:0,dw:gbox.getScreenW(),dh:gbox.getScreenH(),time:30});
		  		}
		  	},
